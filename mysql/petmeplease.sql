...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 29 2018 г., 14:09
...
(33, 'Продам щенков', '2018-01-24 16:51:20', 'Продам ласкового красивого щенка лабрадора. Очень добрый и смышленый мальчик, отлично подойдет для хозяев с детьми.\r\nВсе прививки и документы в наличии.\r\nЩенок с родословной!', '3 месяца', '2', '15 000', 1, 9, 5, 2, 14),
(34, 'Отдам в добрые руки котенка', '2018-01-25 08:57:21', 'Отдаю в хорошие руки милого пушистого котенка. К лотку приучен, очень ласковый и добрый пушистик!', '2 мес', '2', '', 2, 31, 6, 3, 14),
...
(37, 'Отдам в хорошие руки черепаху', '2018-01-24 09:28:41', 'Отдаю свою черепашку &quot;Молнию&quot;. Чудесное создание! Только в ласковые и заботливые руки!', '5 лет', '2', '', 5, 58, 4, 3, 12),
(38, 'Продаю щенка немецкой овчарки', '2018-01-26 09:34:42', 'Продаю щенка немецкой овчарки. Игривая симпатичная девочка. Все документы в наличии, собака привита.', '3 месяца', '2', '3000', 1, 4, 4, 2, 7),
...
(41, 'Продаю щенка ', '2018-01-29 12:00:28', 'Продую щенка джек-раасел-терьера. Очень активная и веселая девочка, подойдет для тех, кто не любит сидеть на месте :)', '5 месяцев', '2', '5000', 1, 7, 7, 2, 14),
(42, 'Отдам в хорошие руки кошечку', '2018-01-29 12:03:13', 'Отдам в добрые заботливые руки кошечку. Милое, послушное и очень ласковое создание.', '3 года', '2', '', 2, 31, 7, 3, 9),
(43, 'Отдам хомяка', '2018-01-29 12:06:31', 'Отдаю в хорошие руки хомяка с клеткой', '2 мес', '1', '', 6, 59, 4, 3, 14),
(44, 'Куплю капибару', '2018-01-29 12:08:50', 'Очень хочу купить капибару, как на картинке! Есть у кого-нибудь предложения? :)', '1-2 года', '1', '', 4, 47, 4, 1, 9);
...
('r704ip1nf2poh6ditoggqotb5o', 'q4sdtkbf3ihppo147tzbl5qmhabi6k7z', 6, '0000-00-00 00:00:00');
...
(59, '2018-01-29 08:16:10', 'Привет! Давно хотела купить себе такого паучка. Где и когда встретимся? :)', 7, 42, 1, 4);
...
(38, 'upload/7/41/jack1.jpg', 41),
(39, 'upload/7/42/k4r2qXZY2wA.jpg', 42),
(40, 'upload/7/42/MeH0GSw213o.jpg', 42),
(41, 'upload/4/43/SHHeki-homyaka-foto4-e1497716271923.jpg', 43),
(42, 'upload/4/43/syr_1.jpg', 43),
(43, 'upload/4/44/capibara.jpg', 44),
(44, 'upload/4/44/capybara1.jpg', 44);
...
--
ALTER TABLE `ad`
  MODIFY `ad_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `message`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
-- AUTO_INCREMENT для таблицы `photo`
--
ALTER TABLE `photo`
  MODIFY `photo_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
